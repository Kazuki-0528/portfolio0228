...
## mock-site（更新運用案件の具体化）

`/mock-site/` 配下に、更新対象として扱う架空コーポレートサイトを追加しました。

- ページ構成：`index.html` / `company.html` / `service.html` / `news.html` / `contact.html` / `recruit.html`
- 更新依頼チケット：`/mock-site/tickets/` に `001.md` 〜 `010.md`
- 更新履歴：`/mock-site/CHANGELOG.md`

`works/mock-maintenance.html` から上記成果物へ相互参照できるようにリンクしています。
